...
#ifndef EDM4HEP_CovMatrix4f_H
#define EDM4HEP_CovMatrix4f_H
...
public:
  ...
  constexpr CovMatrix4f& operator=(std::array<float, 10>& v) {
    values = v;
    return *this;
  }
  bool operator==(const CovMatrix4f& v) const {
...
std::ostream& operator<<(std::ostream& o, const edm4hep::CovMatrix4f& value);

#if defined(PODIO_JSON_OUTPUT) && !defined(__CLING__)
void to_json(nlohmann::json& j, const CovMatrix4f& value);
#endif
