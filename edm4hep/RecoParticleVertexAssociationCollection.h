...
public:
  RecoParticleVertexAssociationCollectionIterator(size_t index,
                                                  const RecoParticleVertexAssociationObjPointerContainer* collection) :
      m_index(index),
      m_object(podio::utils::MaybeSharedPtr<RecoParticleVertexAssociationObj>{nullptr}),
      m_collection(collection) {
  }

  RecoParticleVertexAssociationCollectionIterator(const RecoParticleVertexAssociationCollectionIterator&) = delete;
  RecoParticleVertexAssociationCollectionIterator&
  operator=(const RecoParticleVertexAssociationCollectionIterator&) = delete;
...
public:
  RecoParticleVertexAssociationMutableCollectionIterator(
      size_t index, const RecoParticleVertexAssociationObjPointerContainer* collection) :
      m_index(index),
      m_object(podio::utils::MaybeSharedPtr<RecoParticleVertexAssociationObj>{nullptr}),
      m_collection(collection) {
  }
  ...
  RecoParticleVertexAssociationMutableCollectionIterator(
      const RecoParticleVertexAssociationMutableCollectionIterator&) = delete;
  RecoParticleVertexAssociationMutableCollectionIterator&
  operator=(const RecoParticleVertexAssociationMutableCollectionIterator&) = delete;
...
public:
  ...
  RecoParticleVertexAssociationCollection* operator->() {
    return (RecoParticleVertexAssociationCollection*)this;
  }
  ...
  void push_back(const MutableRecoParticleVertexAssociation& object);
  /// Append an object to the (subset) collection
  void push_back(const RecoParticleVertexAssociation& object);
  ...
  void setID(uint32_t ID) final {
    m_collectionID = ID;
    if (!m_isSubsetColl) {
      std::for_each(m_storage.entries.begin(), m_storage.entries.end(), [ID](RecoParticleVertexAssociationObj* obj) {
