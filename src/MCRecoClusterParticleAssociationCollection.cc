...
MCRecoClusterParticleAssociationCollection::MCRecoClusterParticleAssociationCollection() :
    m_isValid(false),
    m_isPrepared(false),
...
MCRecoClusterParticleAssociationCollection::MCRecoClusterParticleAssociationCollection(
    MCRecoClusterParticleAssociationCollectionData&& data, bool isSubsetColl) :
    m_isValid(false),
    m_isPrepared(false),
...
MCRecoClusterParticleAssociation MCRecoClusterParticleAssociationCollection::operator[](std::size_t index) const {
  return MCRecoClusterParticleAssociation(m_storage.entries[index]);
}

MCRecoClusterParticleAssociation MCRecoClusterParticleAssociationCollection::at(std::size_t index) const {
  return MCRecoClusterParticleAssociation(m_storage.entries.at(index));
}

MutableMCRecoClusterParticleAssociation MCRecoClusterParticleAssociationCollection::operator[](std::size_t index) {
  return MutableMCRecoClusterParticleAssociation(podio::utils::MaybeSharedPtr(m_storage.entries[index]));
}

MutableMCRecoClusterParticleAssociation MCRecoClusterParticleAssociationCollection::at(std::size_t index) {
  return MutableMCRecoClusterParticleAssociation(podio::utils::MaybeSharedPtr(m_storage.entries.at(index)));
}

std::size_t MCRecoClusterParticleAssociationCollection::size() const {
  return m_storage.entries.size();
}

std::size_t MCRecoClusterParticleAssociationCollection::max_size() const {
  return m_storage.entries.max_size();
}

bool MCRecoClusterParticleAssociationCollection::empty() const {
  return m_storage.entries.empty();
}

void MCRecoClusterParticleAssociationCollection::setSubsetCollection(bool setSubset) {
...
MutableMCRecoClusterParticleAssociation MCRecoClusterParticleAssociationCollection::create() {
  if (m_isSubsetColl) {
    throw std::logic_error("Cannot create new elements on a subset collection");
  }

  auto obj = m_storage.entries.emplace_back(new MCRecoClusterParticleAssociationObj());

  obj->id = {int(m_storage.entries.size() - 1), m_collectionID};
  return MutableMCRecoClusterParticleAssociation(podio::utils::MaybeSharedPtr(obj));
}

void MCRecoClusterParticleAssociationCollection::clear() {
  m_storage.clear(m_isSubsetColl);
  m_isPrepared = false;
}

void MCRecoClusterParticleAssociationCollection::prepareForWrite() const {
...
void MCRecoClusterParticleAssociationCollection::prepareAfterRead() {
...
bool MCRecoClusterParticleAssociationCollection::setReferences(const podio::ICollectionProvider* collectionProvider) {
  return m_storage.setReferences(collectionProvider, m_isSubsetColl);
}

void MCRecoClusterParticleAssociationCollection::push_back(const MutableMCRecoClusterParticleAssociation& object) {
  ...
  if (!m_isSubsetColl) {
    ...
    push_back(MCRecoClusterParticleAssociation(object));
  }
}

void MCRecoClusterParticleAssociationCollection::push_back(const MCRecoClusterParticleAssociation& object) {
  if (!m_isSubsetColl) {
...
podio::CollectionWriteBuffers MCRecoClusterParticleAssociationCollection::getBuffers() {
  return m_storage.getCollectionBuffers(m_isSubsetColl);
}

std::vector<float> MCRecoClusterParticleAssociationCollection::weight(const size_t nElem) const {
...
size_t MCRecoClusterParticleAssociationCollection::getDatamodelRegistryIndex() const {
  return edm4hep::meta::DatamodelRegistryIndex::value();
}

podio::SchemaVersionT MCRecoClusterParticleAssociationCollection::getSchemaVersion() const {
...
namespace {
  ...
  podio::CollectionReadBuffers createBuffers(bool isSubset) {
    ...
    readBuffers.type = "edm4hep::MCRecoClusterParticleAssociationCollection";
    readBuffers.schemaVersion = edm4hep::meta::schemaVersion;
    readBuffers.data = isSubset ? nullptr : new MCRecoClusterParticleAssociationDataContainer;
    ...
    readBuffers.createCollection = [](const podio::CollectionReadBuffers& buffers, bool isSubsetColl) {
      MCRecoClusterParticleAssociationCollectionData data(buffers, isSubsetColl);
      return std::make_unique<MCRecoClusterParticleAssociationCollection>(std::move(data), isSubsetColl);
    };
    ...
    readBuffers.recast = [](podio::CollectionReadBuffers& buffers) {
      ...
      if (buffers.data) {
        buffers.data =
            podio::CollectionWriteBuffers::asVector<edm4hep::MCRecoClusterParticleAssociationData>(buffers.data);
      }
    };
    ...
    readBuffers.deleteBuffers = [](podio::CollectionReadBuffers& buffers) {
      if (buffers.data) {
        ...
        // we can delete
        delete static_cast<edm4hep::MCRecoClusterParticleAssociationDataContainer*>(buffers.data);
      }
  ...
  bool registerCollection() {
    const static auto reg = []() {
      ...
      factory.registerCreationFunc("edm4hep::MCRecoClusterParticleAssociationCollection", edm4hep::meta::schemaVersion,
                                   createBuffers);
      ...
      for (unsigned int schemaVersion = 1; schemaVersion < edm4hep::meta::schemaVersion + 1; ++schemaVersion) {
        podio::SchemaEvolution::mutInstance().registerEvolutionFunc(
            "edm4hep::MCRecoClusterParticleAssociationCollection", schemaVersion, edm4hep::meta::schemaVersion,
...
MCRecoClusterParticleAssociation MCRecoClusterParticleAssociationCollectionIterator::operator*() {
  m_object.m_obj = podio::utils::MaybeSharedPtr<MCRecoClusterParticleAssociationObj>((*m_collection)[m_index]);
  return m_object;
}
...
MCRecoClusterParticleAssociationCollectionIterator& MCRecoClusterParticleAssociationCollectionIterator::operator++() {
  ++m_index;
  return *this;
}

MutableMCRecoClusterParticleAssociation MCRecoClusterParticleAssociationMutableCollectionIterator::operator*() {
  m_object.m_obj = podio::utils::MaybeSharedPtr<MCRecoClusterParticleAssociationObj>((*m_collection)[m_index]);
  return m_object;
}
...
void MCRecoClusterParticleAssociationCollection::print(std::ostream& os, bool flush) const {
  os << *this;
  if (flush) {
    os.flush();
  }
