...
RecoParticleVertexAssociationCollection::RecoParticleVertexAssociationCollection() :
    m_isValid(false),
    m_isPrepared(false),
...
RecoParticleVertexAssociationCollection::RecoParticleVertexAssociationCollection(
    RecoParticleVertexAssociationCollectionData&& data, bool isSubsetColl) :
    m_isValid(false),
    m_isPrepared(false),
...
RecoParticleVertexAssociation RecoParticleVertexAssociationCollection::operator[](std::size_t index) const {
  return RecoParticleVertexAssociation(m_storage.entries[index]);
}

RecoParticleVertexAssociation RecoParticleVertexAssociationCollection::at(std::size_t index) const {
  return RecoParticleVertexAssociation(m_storage.entries.at(index));
}

MutableRecoParticleVertexAssociation RecoParticleVertexAssociationCollection::operator[](std::size_t index) {
  return MutableRecoParticleVertexAssociation(podio::utils::MaybeSharedPtr(m_storage.entries[index]));
}

MutableRecoParticleVertexAssociation RecoParticleVertexAssociationCollection::at(std::size_t index) {
  return MutableRecoParticleVertexAssociation(podio::utils::MaybeSharedPtr(m_storage.entries.at(index)));
}

std::size_t RecoParticleVertexAssociationCollection::size() const {
  return m_storage.entries.size();
}

std::size_t RecoParticleVertexAssociationCollection::max_size() const {
  return m_storage.entries.max_size();
}

bool RecoParticleVertexAssociationCollection::empty() const {
  return m_storage.entries.empty();
}

void RecoParticleVertexAssociationCollection::setSubsetCollection(bool setSubset) {
...
MutableRecoParticleVertexAssociation RecoParticleVertexAssociationCollection::create() {
  if (m_isSubsetColl) {
    throw std::logic_error("Cannot create new elements on a subset collection");
  }

  auto obj = m_storage.entries.emplace_back(new RecoParticleVertexAssociationObj());

  obj->id = {int(m_storage.entries.size() - 1), m_collectionID};
  return MutableRecoParticleVertexAssociation(podio::utils::MaybeSharedPtr(obj));
}

void RecoParticleVertexAssociationCollection::clear() {
  m_storage.clear(m_isSubsetColl);
  m_isPrepared = false;
}

void RecoParticleVertexAssociationCollection::prepareForWrite() const {
...
void RecoParticleVertexAssociationCollection::prepareAfterRead() {
...
bool RecoParticleVertexAssociationCollection::setReferences(const podio::ICollectionProvider* collectionProvider) {
  return m_storage.setReferences(collectionProvider, m_isSubsetColl);
}

void RecoParticleVertexAssociationCollection::push_back(const MutableRecoParticleVertexAssociation& object) {
  ...
  if (!m_isSubsetColl) {
    ...
    push_back(RecoParticleVertexAssociation(object));
  }
}

void RecoParticleVertexAssociationCollection::push_back(const RecoParticleVertexAssociation& object) {
  if (!m_isSubsetColl) {
...
podio::CollectionWriteBuffers RecoParticleVertexAssociationCollection::getBuffers() {
  return m_storage.getCollectionBuffers(m_isSubsetColl);
}

std::vector<float> RecoParticleVertexAssociationCollection::weight(const size_t nElem) const {
...
size_t RecoParticleVertexAssociationCollection::getDatamodelRegistryIndex() const {
  return edm4hep::meta::DatamodelRegistryIndex::value();
}

podio::SchemaVersionT RecoParticleVertexAssociationCollection::getSchemaVersion() const {
...
namespace {
  ...
  podio::CollectionReadBuffers createBuffers(bool isSubset) {
    ...
    readBuffers.type = "edm4hep::RecoParticleVertexAssociationCollection";
    readBuffers.schemaVersion = edm4hep::meta::schemaVersion;
    readBuffers.data = isSubset ? nullptr : new RecoParticleVertexAssociationDataContainer;
    ...
    readBuffers.createCollection = [](const podio::CollectionReadBuffers& buffers, bool isSubsetColl) {
      RecoParticleVertexAssociationCollectionData data(buffers, isSubsetColl);
      return std::make_unique<RecoParticleVertexAssociationCollection>(std::move(data), isSubsetColl);
    };
    ...
    readBuffers.recast = [](podio::CollectionReadBuffers& buffers) {
      ...
      if (buffers.data) {
        buffers.data =
            podio::CollectionWriteBuffers::asVector<edm4hep::RecoParticleVertexAssociationData>(buffers.data);
      }
    };
    ...
    readBuffers.deleteBuffers = [](podio::CollectionReadBuffers& buffers) {
      if (buffers.data) {
        ...
        // we can delete
        delete static_cast<edm4hep::RecoParticleVertexAssociationDataContainer*>(buffers.data);
      }
  ...
  bool registerCollection() {
    const static auto reg = []() {
      ...
      factory.registerCreationFunc("edm4hep::RecoParticleVertexAssociationCollection", edm4hep::meta::schemaVersion,
                                   createBuffers);
      ...
      for (unsigned int schemaVersion = 1; schemaVersion < edm4hep::meta::schemaVersion + 1; ++schemaVersion) {
        podio::SchemaEvolution::mutInstance().registerEvolutionFunc(
            "edm4hep::RecoParticleVertexAssociationCollection", schemaVersion, edm4hep::meta::schemaVersion,
...
RecoParticleVertexAssociation RecoParticleVertexAssociationCollectionIterator::operator*() {
  m_object.m_obj = podio::utils::MaybeSharedPtr<RecoParticleVertexAssociationObj>((*m_collection)[m_index]);
  return m_object;
}
...
RecoParticleVertexAssociationCollectionIterator& RecoParticleVertexAssociationCollectionIterator::operator++() {
  ++m_index;
  return *this;
}

MutableRecoParticleVertexAssociation RecoParticleVertexAssociationMutableCollectionIterator::operator*() {
  m_object.m_obj = podio::utils::MaybeSharedPtr<RecoParticleVertexAssociationObj>((*m_collection)[m_index]);
  return m_object;
}
...
RecoParticleVertexAssociationMutableCollectionIterator&
...
void RecoParticleVertexAssociationCollection::print(std::ostream& os, bool flush) const {
  os << *this;
  if (flush) {
    os.flush();
  }
